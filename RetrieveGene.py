...
def main():
    ...
    # Settings for filenames to read in -> save out
    structIDSource = 'layerIDs.csv' # 'structureIDs.csv'
    entrezSource = 'brainGeneEntrezID.csv' # 'geneEntrezID.csv'
    structInfoFilename = 'structureInfoLayers.csv' # structureInfo.csv
    allDataFilename = 'bigDataFrameLayers.csv'

    #---------------------------------------------------------------------------
    # Read in structure IDs from csv -> save detailed structure info to file
    #---------------------------------------------------------------------------
    # structureIDs = np.array([22,39,44])
